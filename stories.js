...
//  *Functions to generate the "My Stories tab"*//
...
//  *Functions to generate the "Favorites tab" as well as functions to favorite and unfavorite certain posts.*//
...
async function toggleStoryFavorite(evt) {
  ...
  // *checks to see if target has been starred. If not it will change star and remove from favorites list.*//
